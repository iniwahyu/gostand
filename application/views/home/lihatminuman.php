...
<body>
    ...
    <div class="agile_inner_breadcrumb">
      <div class="container">
        <ul class="w3_short">
          ...
          <li><?php foreach($data as $minuman) { echo $minuman['nama_produk']; } ?></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="banner-bootom-w3-agileits">
    <div class="container">
      <!-- tittle heading -->
      <h3 class="tittle-w3l"><?php foreach($data as $minuman) { echo $minuman['nama_produk']; } ?>
        ...
        <div class="grid images_3_of_2">
          <div class="flexslider">
            ...
            <?php foreach($data as $minuman) { ?>
              <li data-thumb="<?php echo base_url('asset/img/produk/').$minuman['nama_file']; ?>" >
                <div class="thumb-image">
                  <img src="<?php echo base_url('asset/img/produk/').$minuman['nama_file']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
              </li>
            <?php } ?>
            </ul>
      ...
      <div class="col-md-7 single-right-left simpleCart_shelfItem">
        ...
        <p>
          <span class="item_price">Rp. <?php echo number_format($produk['harga'],2,'.','.'); ?></span>
