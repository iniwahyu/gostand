...
<!-- Content -->
  ...
  <div class="container">
    <div>
      <!-- tittle heading -->
      <h3 style="margin-top: 50px;" class="tittle-w3l">My Profile
          ...
          <div class="col-md-6">
            <table class="table">
              ...
              <tr>
                ...
                <td><label>:</label></td>                
                <td>bugisetiawan98@gmail.com</td>
              </tr>
              <tr>
            ...
            <a href="<?php echo base_url('pembeli/editprofile'); ?>" class="btn btn-primary">Edit Profile</a>
          </div>
        </div>
      </div>
    </div>
